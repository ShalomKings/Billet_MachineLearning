...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 11:59:03 2024
...
def charger_model_et_scaler():
    model=joblib.load(open("lrtest.pkl", "rb"))
    scaler = joblib.load(open("scalerbillet.pkl","rb"))
    return model, scaler

# Rappel du modèle
model, scaler = charger_model_et_scaler()

st.sidebar.title("Bienvenue sur la plateforme d'authentification de billet 💸") 
st.sidebar.write("""
                 Cette applicaton permet d'authentifier les billets'
                 """) 
